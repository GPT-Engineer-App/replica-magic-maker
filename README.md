...
**Project**: replica-magic-maker 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: make and exact replica of this site  
...
```sh
git clone https://github.com/GPT-Engineer-App/replica-magic-maker.git
cd replica-magic-maker
npm i
